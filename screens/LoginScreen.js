...
export default class LoginScreen extends React.Component {
    ...
    handleSignIn = () => {
        // Vérifier si les champs d'email et de mot de passe sont vides
    ...
    render() {
        return (
            <View style={styles.container}>
                <Text style={styles.greeting}>Bonjours !{'\n'}Bienvenue Dans SocialBook</Text>
                <View style={styles.errorMessage}>{this.state.errorMessage !== "" && <Text style={styles.error}>{this.state.errorMessage}</Text>}
                </View>

                <View style={styles.form}>
                    <View>
                        <Text style={styles.inputTitle}>Addresse Email</Text>
                        <TextInput  
                            style={styles.input} 
                            autoCapitalize="none" 
                    ...
                    <TouchableOpacity style={{ alignSelf: "center", marginTop: 32 }} onPress={() => this.props.navigation.navigate("Register")}>
                        <Text style={{ color: "#414959", fontSize: 13 }}>
                            Nouveau sur SocialBook? <Text style={{ fontWeight: "500", color: "#E9446A" }}>Créez un compte</Text>
                        </Text>
                    </TouchableOpacity>
                </View>
            </View>
